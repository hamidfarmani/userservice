package com.hamid.userservice.controller;
...
import com.hamid.userservice.dto.RoleToUserDTO;
import com.hamid.userservice.security.CustomAuthorizationFilter;
    ...
    if (authorizationHeader != null && authorizationHeader.startsWith("Bearer ")) {
      ...
      try {
        ...
        String accessToken = JWT.create()
            ...
            .withClaim("roles",user.getRoles().stream().map(Role::getName).collect(
                Collectors.toList()))
            .sign(algorithm);
